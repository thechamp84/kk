...
const ProductList = [
    {
      images: [catOne, catTwo, catThree, catFour],
    ...
    {
      images: [catTwo, catTwo, catTwo, catTwo],
    ...
    {
      images: [catThree, catThree, catThree, catThree],
    ...
    {
      images: [catFour, catFour, catFour, catFour],
    ...
    {
      images: [catFive, catFive, catFive, catFive],
    ...
    {
      images: [catSix, catSix, catSix, catSix],
    ...
    {
      images: [catSeven, catSeven, catSeven, catSeven],
    ...
    {
      images: [catEight, catEight, catEight, catEight],
    ...
    {
      images: [catNine, catNine, catNine, catNine],
    ...
    {
      images: [catTen, catTen, catTen, catTen],
    ...
    {
      images: [catEleven, catEleven, catEleven, catEleven],
    ...
    {
      images: [catTwelve, catTwelve, catTwelve, catTwelve],
